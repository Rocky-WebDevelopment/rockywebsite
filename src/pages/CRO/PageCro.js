    ...
    return (
        <div>
            ...
            <div className="container">
                ...
                <p>Já pensou por que o número de conversões do seu site está baixo mesmo tendo um bom tráfego? Com a implementação de uma estratégia de CRO é possível melhorar o desempenho da sua página e levar o usuário até uma ação positiva para seus resultados.</p>
                <p>
                    Nosso time de CRO é responsável por fazer uma análise técnica e comportamental do seu site, que através de um conjunto de práticas e otimizações, visa aumentar suas conversões. 
                </p>
                <p>
                ...
                <p>
                    Utilizando ferramentas referência no mercado, trabalhamos com uma análise combinada dessas informações para fazer um levantamento de hipóteses inicial. 
                </p>

                <p>
                    Estudamos sobre a experiência do usuário no site, o caminho de conversão do cliente e realizamos um estudo de persona para entender melhor seu comportamento.
                </p>
                ...
                <p>
                    A implementação dessas melhorias também pode ser feita pelo nosso time.
                </p>
            </div>
        </div>
    )
