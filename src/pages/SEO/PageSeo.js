    ...
    return (
        <div>
            ...
            <div className="container">
                ...
                <p>
                    Um site sem visibilidade não consegue trazer resultados positivos. O SEO é a área multidisciplinar responsável por analisar páginas e seus conteúdos, de acordo com os critérios determinados pelos mecanismos de busca, e implementar otimizações que tragam um maior tráfego orgânico qualificado para os sites, gerando maiores conversões.
                </p>
                <p>
                    Na ROCKY, através de um SEO técnico, uma visão analítica de profissionais preparados e com um acompanhamento e estudo frequentes, nosso time de SEO entrega, além de melhores resultados, uma parceria estratégica para empresas que desejam crescer no orgânico.
                </p>
                <p>
                ...
                <p>
                    Trazemos relatórios com uma análise aprofundada sobre cada uma das páginas disponíveis e sugestões de melhorias, com insights estratégicos que vão gerar um maior e melhor fluxo dentro do seu site.
                </p>
